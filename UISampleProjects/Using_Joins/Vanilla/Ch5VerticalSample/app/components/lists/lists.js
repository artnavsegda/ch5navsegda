...
var listsModule = (function () {
     ...
     */
    var listScrollElement = document.getElementById('listScrollerPanel');
    ...
    function toggleContact() {
        ...
        if (detailElm.classList.contains('open')) {
            listScrollerElm.firstElementChild.classList.remove('iphone6-list');
        } else {
            listScrollerElm.firstElementChild.classList.add('iphone6-list');
        }
        setTimeout(function () {
            setListHeight();
        }, 301);
     ...
     */
    var listsPage = document.querySelector('.lists-page');
