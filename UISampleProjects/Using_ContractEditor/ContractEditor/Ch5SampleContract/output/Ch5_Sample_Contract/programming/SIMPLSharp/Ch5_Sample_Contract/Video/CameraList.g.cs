...
namespace Ch5_Sample_Contract.Video
{
    ...
    public interface ICameraList
    {
        ...
        Ch5_Sample_Contract.Video.ICamera[] Cameras { get; }
    }
    ...
    internal class CameraList : ICameraList, IDisposable
    {
        ...
        public Ch5_Sample_Contract.Video.ICamera[] Cameras { get; private set; }
        ...
        public void Dispose()
        {
            ...
            for (int index = 0; index < Cameras.Length; index++)
            {
                ((Ch5_Sample_Contract.Video.Camera)Cameras[index]).Dispose();
            }
