...
namespace CH5SampleSSP.Contact
{
    /// <summary>
    ...
    internal class ContactList : IContactList, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId)
        {
            ...
            Contact = new IContact[contactList.Count];
            for (int index = 0; index < contactList.Count; index++)
            {
                Contact[index] = new CH5SampleSSP.Contact.Contact(ComponentMediator, contactList[index]); 
            }
        ...
        public void Dispose()
        {
            ...
            for (int index = 0; index < Contact.Length; index++)
            {
                ((CH5SampleSSP.Contact.Contact)Contact[index]).Dispose();
            }
