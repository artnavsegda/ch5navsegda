...
namespace Ch5_Sample_Contract.Lighting
{
    public interface ILightingList
    {
        ...
        Ch5_Sample_Contract.Lighting.IDimmableLoad[] DimmableLoad { get; }
    }
    ...
    public class LightingList : ILightingList, IDisposable
    {
        ...
        private void Initialize(BasicTriListWithSmartObject[] devices, uint controlJoinId)
        {
            if (_devices == null)
            {
                ...
                DimmableLoad = new Ch5_Sample_Contract.Lighting.IDimmableLoad[dimmableLoadList.Count];
                for (int index = 0; index < dimmableLoadList.Count; index++)
                {
                    DimmableLoad[index] = new Ch5_Sample_Contract.Lighting.DimmableLoad(devices, dimmableLoadList[index]); 
                }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            {
                ((Ch5_Sample_Contract.Lighting.DimmableLoad)DimmableLoad[index]).AddDevice(device);
            }
        }
        ...
        public Ch5_Sample_Contract.Lighting.IDimmableLoad[] DimmableLoad { get; private set; }
        ...
        public void Dispose()
        {
            ...
            for (int index = 0; index < DimmableLoad.Length; index++)
            {
                ((Ch5_Sample_Contract.Lighting.DimmableLoad)DimmableLoad[index]).Dispose();
            }
